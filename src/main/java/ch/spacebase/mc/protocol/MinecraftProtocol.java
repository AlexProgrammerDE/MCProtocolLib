...
import ch.spacebase.mc.protocol.packet.ingame.client.*;
...
import ch.spacebase.mc.protocol.packet.ingame.client.entity.player.*;
import ch.spacebase.mc.protocol.packet.ingame.client.window.*;
...
import ch.spacebase.mc.protocol.packet.ingame.server.entity.*;
import ch.spacebase.mc.protocol.packet.ingame.server.entity.player.*;
import ch.spacebase.mc.protocol.packet.ingame.server.entity.spawn.*;
...
import ch.spacebase.mc.protocol.packet.ingame.server.window.*;
import ch.spacebase.mc.protocol.packet.ingame.server.world.*;
